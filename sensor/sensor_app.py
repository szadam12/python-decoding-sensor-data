...
print("\nHouse Temperature sensor record for date {} = {}".format(test_date.strftime("%m/%d/%y"), len(recs)))
print("\tMaximum: {0}, Minimum: {1} temperatures".format(max(recs), min(recs)))
...
print("House Particle sensor records for area {} = {}".format(test_area,len(recs)))
